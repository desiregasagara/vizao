...
const About = () =>{
    ...
    <div className={styles.background} id="about">
        <div className={styles.introText}>
            ...
            <h1 className={styles.pageTitle}> We build seamless Web and Mobile Software</h1>
            <hr className={styles.lines} ></hr>
        ...
        <div classname={styles.imageBar}>
            <div className={styles.imageDetails}>
                <StaticImage src="../../images/hal-gatewood-tZc3vjPCk-Q-unsplash.jpg" 
        ...
        <div classname={styles.imageBar}>
            ...
            <div className={styles.imageDetails2}>
                <StaticImage src="../../images/amelie-mourichon-sv8oOQaUb-o-unsplash.jpg" 
                alt="sketch of app concepts"
        ...
        <div classname={styles.imageBar}>
            <div className={styles.imageDetails}>
                <StaticImage src="../../images/christopher-gower-m_HRfLhgABo-unsplash (1).jpg" 
                alt="sketch of app concepts"
                className={styles.image1}
                />
            </div>
            ...
            <div className={styles.imageDetails2}>
                <StaticImage src="../../images/myriam-jessier-eveI7MOcSmw-unsplash.jpg" 
                alt="sketch of app concepts"
                className={styles.image2}
                />
            </div>
